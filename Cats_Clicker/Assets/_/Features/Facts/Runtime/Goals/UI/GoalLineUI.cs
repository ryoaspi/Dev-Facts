        ...
        private void ApplyLocalization()
        {
            if (m_label)
            {
                if (!string.IsNullOrEmpty(_goalDef.m_LabelKey))
                    m_label.text = LocalizationManager.GetText(_goalDef.m_LabelKey);
                else
                    m_label.text = _goalDef.m_Label;
            }

            if (m_description)
            {
                if (!string.IsNullOrEmpty(_goalDef.m_DescriptionKey))
                    m_description.text = LocalizationManager.GetText(_goalDef.m_DescriptionKey);
                else
                    m_description.text = _goalDef.m_Description;
            }
        }
